...
function nathers_2016_file_link($variables) {
    ...
    if (empty($file->description)) {
        $link_text = $file->filename . ' <span class="file-icon ' . strtolower($file->extension) . '">&nbsp;' . $file->extension . '&nbsp; ' . format_size($file->filesize) . '</span>';
    } else {
        $link_text = $file->description . ' <span class="file-icon ' . strtolower($file->extension) . '">&nbsp;'  . $file->extension . '&nbsp;' . format_size($file->filesize) . '</span>';
